...
export function loadSeedFromExcel(filePath = resolveExcelPath()): ExcelSeed {
  ...
  ensureWarehouse({
    ...
    name: "Fabrika (Mamul)",
    type: "finished",
    description: "Üretimden çıkan mamul stoğu",
    location: "Fabrika",
    capacity: 50000,
    used: 0,
    temperature: "15-25°C",
  ...
  ensureWarehouse({
    id: "wh-mamul-internet",
    name: "İnternet satışı",
    type: "finished",
    description: "E-ticaret mamul deposu",
    location: "Fabrika / Online",
    capacity: 20000,
    used: 0,
    temperature: "15-25°C",
    humidity: "%40-60",
  ...
  ensureWarehouse({
    id: "wh-mamul-istanbul",
    name: "İstanbul deposu",
    type: "finished",
    description: "İstanbul mamul deposu",
    location: "İstanbul",
    capacity: 30000,
    used: 0,
    temperature: "15-25°C",
