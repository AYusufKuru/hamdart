...
function emptyForm(row?: Customer) {
  return {
    ...
    accountList: row?.accountList || "Müşteri",
...
export function CustomerFormSheet({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (editing) {
        await updateCatalog("customers", editing.id, body);
        toast.success("Müşteri güncellendi");
      } else {
        await createCatalog("customers", body);
  ...
  return (
    <FormDialog
      ...
      title={editing ? "Müşteriyi düzenle" : "Yeni hesap"}
      description="Müşteri kartını bölüm bölüm doldurun. Yalnızca hesap adı zorunludur."
        ...
        <Tabs value={tab} onValueChange={setTab} className="flex min-h-0 flex-1 flex-col">
          ...
          <FormSheetBody className="space-y-5">
            <TabsContent value="definition" className="mt-0 space-y-4">
              <FormField label="Hesap adı" htmlFor="cus-name" required>
                <Input
                  id="cus-name"
                  required
              ...
              <div className="space-y-1">
                ...
                {showTaxLookup ? (
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <FormField label="Vergi no" htmlFor="cus-tax-lookup" optional>
                      <Input
                        id="cus-tax-lookup"
                        value={form.taxNo}
                        onChange={(e) =>
                    ...
                    <FormField label="TC" htmlFor="cus-tc-lookup" optional>
                      <Input
                        id="cus-tc-lookup"
                        inputMode="numeric"
                        maxLength={11}
                ...
                {showInvoiceName ? (
                  <FormField label="Fatura adı" htmlFor="cus-invoice-name" optional>
                    <Input
                      id="cus-invoice-name"
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <FormField label="Hesap kodu" htmlFor="cus-code" optional>
                  <Input
                    id="cus-code"
                    className="font-mono"
            ...
            <TabsContent value="contact" className="mt-0 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                <FormField label="Cep numarası" htmlFor="cus-mobile" optional>
                  <Input
                    id="cus-mobile"
                    type="tel"
                    inputMode="numeric"
                ...
                <FormField label="E-posta adresi" htmlFor="cus-email" optional>
                  <Input
                    id="cus-email"
                    type="email"
                ...
                <FormField label="Sabit telefon" htmlFor="cus-landline" optional>
                  <Input
                    id="cus-landline"
                    type="tel"
                    inputMode="numeric"
            ...
            <TabsContent value="finance" className="mt-0 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                ...
                <FormField label="Vergi dairesi" htmlFor="cus-tax-office" optional>
                  <Input
                    id="cus-tax-office"
                ...
                <FormField label="TC" htmlFor="cus-tc" optional>
                  <Input
                    id="cus-tc"
                    inputMode="numeric"
                    maxLength={11}
              ...
              <FormSection title="Önceki bakiye">
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <FormField label="Devir bakiye" htmlFor="cus-opening" optional>
                    <Input
                      id="cus-opening"
                      type="number"
                      min={0}
              ...
              <FormSection title="Borç yönetimi">
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  <FormField label="Vade (gün sayısı)" htmlFor="cus-term" optional>
                    <Input
                      id="cus-term"
                      type="number"
                      min={0}
                  ...
                  <FormField label="Borç limiti" htmlFor="cus-limit" optional>
                    <Input
                      id="cus-limit"
                      type="number"
                      min={0}
              ...
              <FormSection title="Diğer">
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  <FormField label="Şube" htmlFor="cus-branch" optional>
                    <Input
                      id="cus-branch"
                      value={form.branch}
                      onChange={(e) =>
                  ...
                  <FormField label="Ödeme vergi no" htmlFor="cus-pay-tax" optional>
                    <Input
                      id="cus-pay-tax"
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                {form.relatives.map((row, index) => (
                  <FormSection key={index} title={`${index + 1}. Yakın bilgisi`}>
                    <FormField label="Adı soyadı" htmlFor={`cus-rel-name-${index}`} optional>
                      <Input
                        id={`cus-rel-name-${index}`}
                    ...
                    <FormField label="Cep numarası" htmlFor={`cus-rel-phone-${index}`} optional>
                      <Input
                        id={`cus-rel-phone-${index}`}
                        type="tel"
                        inputMode="numeric"
                        placeholder="Cep Numarası"
                        value={row.phone}
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                {form.guarantors.map((row, index) => (
                  <FormSection key={index} title={`${index + 1}. Kefil bilgileri`}>
                    <FormField label="Adı soyadı" htmlFor={`cus-g-name-${index}`} optional>
                      <Input
                        id={`cus-g-name-${index}`}
                        placeholder="Adı Soyadı"
                        value={row.name}
                    ...
                    <FormField label="TC" htmlFor={`cus-g-tc-${index}`} optional>
                      <Input
                        id={`cus-g-tc-${index}`}
                        inputMode="numeric"
                        maxLength={11}
                    ...
                    <FormField label="Adres" htmlFor={`cus-g-addr-${index}`} optional>
                      <Input
                        id={`cus-g-addr-${index}`}
                        placeholder="Adres"
                        value={row.address}
                    ...
                    <FormField label="Cep no" htmlFor={`cus-g-phone-${index}`} optional>
                      <Input
                        id={`cus-g-phone-${index}`}
                        type="tel"
                        inputMode="numeric"
                        placeholder="Cep No"
                        value={row.phone}
